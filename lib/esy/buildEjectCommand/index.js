...
const fastReplaceStringSrc = fs.readFileSync(require.resolve('fastreplacestring/fastreplacestring.cpp'), 'utf8');
...
function buildEjectCommand(sandbox) {
  ...
  let sandboxPath = function (packageInfo, tree) {
